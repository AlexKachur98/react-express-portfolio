...
// Lazy load VantaBackground to defer loading THREE.js (~400KB) until needed.
// This improves initial page load time significantly.
const VantaBackground = lazy(() => import('../common/VantaBackground.jsx'));
        ...
        <div className="app-shell">
            ...
            {!isCatGallery && (
                <Suspense
                    fallback={
                        <div
                            className="vanta-background vanta-background--loading"
                            aria-hidden="true"
                        />
                    }
                >
            ...
            <main id="main-content" className={`app-main ${isCatGallery ? 'app-main--cat' : ''}`}>
                <Outlet />
            </main>
        </div>
    );
